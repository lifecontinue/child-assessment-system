...
DROP POLICY IF EXISTS "Users can view own daily_records" ON daily_records;
DROP POLICY IF EXISTS "Users can insert own daily_records" ON daily_records;
DROP POLICY IF EXISTS "Users can update own daily_records" ON daily_records;
